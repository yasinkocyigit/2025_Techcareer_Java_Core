...
public class _18_1_POJO_2_Class {
    ...
    public _18_1_POJO_2_Class() {
    }

    // PARAMETRELİ CONSTRUCTOR
    public _18_1_POJO_2_Class(String name, String surname) {
        this.name = name;
        this.surname = surname;
    }

    // PARAMETRELİ CONSTRUCTOR (OVERLOADING)
    public _18_1_POJO_2_Class(String name, String surname, int number) {
        this.name = name;
        this.surname = surname;
        this.number = number;
    }
