...
public enum _16_3_ConstructorEnum implements dataPrint {
   ...
   SUCCESS(200),CREATED(201), NOT_FOUND(404), INTERNAL_ERROR(500), BAD_REQUEST(400);
    ...
    private _16_3_ConstructorEnum(int kod) {
        this.kod = kod;
    }
...
class EnumMain{
    public static void main(String[] args) {
        System.out.println(_16_3_ConstructorEnum.NOT_FOUND);
        System.out.println(_16_3_ConstructorEnum.NOT_FOUND.getKod());
        System.out.println(_16_3_ConstructorEnum.NOT_FOUND+ "("+ _16_3_ConstructorEnum.NOT_FOUND.getKod()+")");
