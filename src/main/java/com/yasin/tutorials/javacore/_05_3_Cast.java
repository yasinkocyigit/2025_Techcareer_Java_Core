...
public class _05_3_Cast {
    ...
    public static void main(String[] args) {
        ...
        int castStringToInt1 = Integer.valueOf(cast4String); // 1.YOL Wrapper ==> "Bu public static Integer valueOf"
        int castStringToInt2 = Integer.parseInt(cast4String); // 2.YOL Primitive ==> "public static int parseInt" Bu
